...
SESSION_COOKIE_DOMAIN = "nb.einfachzocken.eu"
...
AUTO_PREMIUM = True # Everyone should get Premium!
# AUTO_PREMIUM = False
if not AUTO_PREMIUM:
...
STRIPE_SECRET = "YOUR-SECRET-API-KEY" # dont need this
STRIPE_PUBLISHABLE = "YOUR-PUBLISHABLE-API-KEY" # not this either
...
SERVER_NAME = "nbeinfachzocken"
NEWSBLUR_URL = os.getenv("NEWSBLUR_URL", "https://nb.einfachzocken.eu")

if NEWSBLUR_URL == "https://nb.einfachzocken.eu":
    SESSION_COOKIE_DOMAIN = "nb.einfachzocken.eu"
...
RECAPTCHA_SECRET_KEY = "0000000000000000000000000000000000000000" # let's pray i dont need this (otherwise i have to migrate to librecaptcha or something)
